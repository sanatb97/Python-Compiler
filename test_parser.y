...
%}
%start file_input
%token T_name T_number T_string T_newline T_eof T_semi_colon T_eq T_comma  T_del T_pass T_break T_continue T_return T_import T_from T_star T_Lparan T_Rparan T_as T_dot T_if T_colon T_elif T_else T_indent T_dedent T_or T_and T_not T_lt T_gt T_deq T_ge T_le T_noteq T_is T_isnot T_notin T_bitwiseor T_bitwiseand T_bitwisexor T_leftshift T_rightshift T_plus T_minus T_divide T_mod T_double_divide T_tilde T_double_star   T_squarebleft T_squarebright  T_none T_true T_false
